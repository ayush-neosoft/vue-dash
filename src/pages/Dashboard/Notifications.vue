  ...
  <div>
    ...
    <div class="md-layout">
      ...
      <div class="md-layout-item md-size-50 md-small-size-100">
        <md-card>
          <md-card-header>
            <div class="md-layout" :class="md-alignment-center-space-between">
              <div class="md-layout-item md-size-30">
                <h4 class="title">4 Notifications</h4>
              </div>

              <div class="md-layout-item md-size-60"></div>

              <div class="md-layout-item md-size-10">
                <md-button class="md-icon-button md-accent" title="Clear All">
          ...
          <md-card-content>
            ...
            <div class="text-center">
              ...
              <modal v-if="noticeModal" @close="noticeModalHide">
                ...
                <template slot="footer">
                  <md-button class="md-info md-round" @click="noticeModalHide"
                    >Sound Good</md-button
                  >
                </template>
              </modal>
